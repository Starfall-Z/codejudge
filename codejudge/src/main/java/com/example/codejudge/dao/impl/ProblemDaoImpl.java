...
public class ProblemDaoImpl extends JdbcDaoSupport implements ProblemDao {
    ...
    public void save(Problem p) {
        String sql = "INSERT INTO problems (title, description, time_limit, memory_limit, input, output) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void update(Problem p) {
        String sql = "UPDATE problems SET title = ?, description = ?, time_limit = ?, memory_limit = ?, input = ?, output = ? WHERE id = ?";
